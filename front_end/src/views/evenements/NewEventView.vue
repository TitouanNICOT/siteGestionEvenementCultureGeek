        ...
        addEvent() {
            ...
            if (this.$refs.form.validate() && this.additionnalValidation())
                myaxios.post('/evenements', {
                    ...
                    myaxios.get("/evenements/"+result.data.data.idEvenement).then((result2) => {
                        this.addEvenement(Evenement.fromAPI(result2.data.data))
